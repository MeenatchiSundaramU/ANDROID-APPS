...
class ProductActivity : AppCompatActivity() {
    ...
    private fun getData(fuseloc:FusedLocationProviderClient,views:Context)
    {
        ...
        val flesher_ref=FirebaseDatabase.getInstance().getReference("/FlesherAddProduct/${ind_buyer_data!!.flesname}/${get_data!!.district}/${get_data!!.city}/${ind_buyer_data!!.flesh_uid}")
        ...
        flesher_ref.addListenerForSingleValueEvent(object :ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (h in p0.children) {
                    ...
                    pro_adapter.add(ProAdapter(get_product!!,fuseloc,views,this@ProductActivity))
                }
    ...
    class ProAdapter(val product:Poduct, var locationss:FusedLocationProviderClient, val views:Context,val activity:ProductActivity): Item<ViewHolder>()
    {
        ...
        override fun bind(viewHolder: ViewHolder, position: Int) {
            Picasso.get().load(product.fleshimage).into(viewHolder.itemView.flesh_image_show)
            ...
            viewHolder.itemView.getpricebtn.setOnClickListener {
                ...
                tot_price=(viewHolder.itemView.req_value.text.toString().toDouble()*viewHolder.itemView.pricevalue.text.toString().toDouble()+30)
                viewHolder.itemView.price_display.setText("Rs."+viewHolder.itemView.price_display.text.toString()+tot_price.toString())
            ...
            viewHolder.itemView.cartbtn.setOnClickListener {
                ...
                it.context.startActivity(Intent(activity,CartSplash::class.java))
            }
        }
