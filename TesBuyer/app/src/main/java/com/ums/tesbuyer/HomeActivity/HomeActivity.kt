...
import com.ums.tesbuyer.HomeActivity.Home_Fragment.Notifications.Notifications
import com.ums.tesbuyer.HomeActivity.Home_Fragment.Notifications.RequirementFragment
...
//                }
                R.id.contact->{
                    supportActionBar!!.title = "Admin Info"
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.home_frame, ContactFragment())
                        .commit()
                }
            }
